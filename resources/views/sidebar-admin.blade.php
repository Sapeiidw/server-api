<aside class="sidebar dark:bg-gray-700 dark:text-white dark:border-gray-700 md:max-w-1/5 w-1/5 sticky-top-0 relative shadow-md rounded-t-2xl overflow-x-hidden border border-gray-200 mt-2 ml-2 bg-sidebar bg-white h-min-screen sm:block">
