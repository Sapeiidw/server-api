<div class=" min-h-screen shadow-xl flex md:justify-around sm:justify-center items-center">
    {{-- flex-wrap-reverse --}}
    <div class="w-full sm:max-w-2xl sm:max-h-3xl max-h-full sm:flex flex-row-reverse px-4 py-4 dark:bg-gray-800 dark:text-white bg-white shadow-md justify-center rounded-3xl">
