        ...
        <x-boxtable>
            <div class=" flex justify-between sm:flex-row flex-col py-4 px-2">
                <div class="flex relative sm:w-3/4">
                    ...
                    <form class="w-full" action="{{ route('role.index') }}" method="get">
                        ...
                        class="appearance-none rounded-full dark:border-gray-800 dark:bg-gray-600 border border-gray-400 border-b block sm:pt-2 pl-8 pr-6 py-2 w-full bg-white text-sm placeholder-gray-400 text-gray-700 focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none" />
                    </form>
                </div>
                <x-jet-button>
            ...
            <div class="pt-4 mx-auto overflow-x-auto">
                <div class="inline-block dark:text-white dark:border-gray-800 border min-w-full rounded-lg overflow-hidden">
                    ...
                    <div
                        class="px-5 py-5 dark:bg-gray-600 bg-white flex flex-col xs:flex-row items-center xs:justify-between          ">
                        {{ $roles->links() }}
                    </div>
                </div>
            </div>
