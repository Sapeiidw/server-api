        ...
        <div class="flex justify-between sm:flex-row flex-col py-4 px-2">
            <div class="flex relative sm:w-3/4">
                ...
                <form class="w-full" action="{{ route('log.index') }}" method="get">
                    ...
                    class="appearance-none rounded-full dark:border-gray-800 dark:bg-gray-600 border border-gray-400 border-b block pl-8 pr-6 py-2 w-full bg-white text-sm placeholder-gray-400 text-gray-700 focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none" />
                </form>
            </div>
